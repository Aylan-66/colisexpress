...
void main() {
  runApp(const ColisExpressRelais());
}

class ColisExpressRelais extends StatelessWidget {
  const ColisExpressRelais({super.key});
  ...
  Widget build(BuildContext context) {
    return Provider<ApiService>(
      ...
      child: MaterialApp(
        title: 'Colis Express Point Relais',
...
class _AuthGateState extends State<AuthGate> {
  ...
  void _onSessionExpired() {
    if (!mounted) return;
    // Pop les écrans empilés pour revenir à la racine, sinon le LoginScreen reste caché.
